...
namespace rest_api_dotnet.Controllers
{
    ...
    public class GreetingsController : ControllerBase
    {
        ...
        {
            new Greeting(){Id=1,Recipient="Cizzbor",Message= "Merry whatever",Sender="Kristjan"},
            new Greeting(){Id=2,Recipient="Woowo",Message= "Happy hannusomething",Sender="Kristjan"},
            new Greeting(){Id=3,Recipient="Crazlinger",Message= "Superb season",Sender="Kristjan"}
        };
